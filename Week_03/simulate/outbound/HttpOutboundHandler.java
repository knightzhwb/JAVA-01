...
import simulate.filter.HeaderHttpResponseFilter;
import simulate.router.HttpEndpointRouter;
import simulate.router.RandomHttpEndpointRouter;
...
public class HttpOutboundHandler {
    ...
    public void handle(FullHttpRequest fullRequest, ChannelHandlerContext ctx) {
        ...
        System.out.println("当前请求的服务地址："+url+"  time:"+df.format(new Date()));
        System.out.println("当前请求的headers中属性mao的值："+fullRequest.headers().get("mao")+"  time:"+df.format(new Date()));
        filter.filter(fullRequest);
        System.out.println("过滤器在请求的headers中增加属性mao的值："+fullRequest.headers().get("mao")+"  time:"+df.format(new Date()));
        fetchGet(fullRequest, ctx, url);
    }
